        ...
        <div className="container py-5">
            <div className="row justify-content-center">
                <div className="col-lg-10 col-md-11 col-12">
                    <h1 className="mb-4 text-center">Privacy Policy - Credent Health Medical</h1>
                    ...
                    <div className="mb-4">
                        ...
                        <p className="mt-2">
                            ...
                            <a href="https://mail.google.com/mail/?view=cm&to=manojkumar63019@gmail.com" target="_blank" rel="noopener noreferrer">
                                manojkumar63019@gmail.com
                            </a>
                    ...
                    <div className="mb-4">
                        ...
                        <p>
                            Credent Health Medical is intended for users 16 years and older. We do not knowingly collect data from children under 16 without verified parental consent.
                        </p>
                    </div>
